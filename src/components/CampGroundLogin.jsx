        ...
        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
          <div class="card shadow-2-strong" style={{borderRadius: "1rem"}}>
            <div class="card-body p-5 text-center">
              ...
              <button class="btn btn-primary btn-lg btn-block w-100" type="submit" onClick={handleSubmit(handleLocalAuth)}>Login</button>
              <p>Don't have an account? <Link to="/register" class="link-info">Register here</Link></p>
              <hr class="my-4"/>

  
              <button class="btn btn-lg btn-block btn-primary w-100 mb-2" style={{backgroundColor: "#dd4b39"}}
                type="submit" onClick={handleGoogleAuth}><i class="bi bi-google me-2"></i> Sign in with google</button>
              <button class="btn btn-lg btn-block btn-primary mb-2 w-100" style={{backgroundColor: "#3b5998"}}
